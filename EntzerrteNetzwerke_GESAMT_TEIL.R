...
plot(stuggi, layout=coords, rescale=FALSE,ylim=c(-4.6,7.5),xlim=c(-2.5,1.5), asp= 0.5,edge.width = 2,edge.curved=TRUE, vertex.label.font=2,vertex.size=23, vertex.label.dist=5,vertex.label.degree = pi/-2, vertex.label.cex=.5,vertex.label.family = "Arial",edge.arrow.size=0.2,main="Startups-Stuttgart")
